...
public class GenericTest {
	...
	public static void main(String[] args) {
		...
		ng1.setValue("가나다라"); // outoBoxing
		
		NonGeneric ng2 = new NonGeneric();
		ng2.setValue(100); // outoBoxing
		
		String temp1 = (String)ng1.getvalue();//Object형으로 변환되어 저장되었고 꺼내질때도 Object로 꺼내진다. 부모데이터가 자식데이터에 넣을때는 자동형변환이 불가능=> 강제형변환

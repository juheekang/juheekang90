...
//		File file1 = new File("d:\\d_other\\test.txt");	// 구분문자로 '\'를 사용했을 경우, '\'는 문자열안에서 \\두번써야함
		File file1 = new File("d:/d_other/test.txt");	// 구분문자로 '/'를 사용했을 경우
...
//		System.out.println("디렉토리일까? : " + file5.isDirectory());  //false
//		System.out.println("파일일까? : " + file5.isFile());			//false
		System.out.println(file5.getName() + "의 존재 여부 : " + file5.exists());  //false 
		...
		File file6 = new File("d:/d_other/test/java/src");  //src를 만들려면 java와 test폴더가 만들어져있어야 한다.
		if(!file6.exists()) {
			if(file6.mkdirs()) {
